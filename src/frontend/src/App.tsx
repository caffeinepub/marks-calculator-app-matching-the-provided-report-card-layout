import { Cloud, Download, Printer, RotateCcw, Upload } from "lucide-react";
...
import { defaultFields, defaultSubjects } from "./lib/defaultData";
import {
  buildExportPayload,
  downloadJSON,
  readFileAsText,
  validateAndParseImport,
} from "./lib/reportCardIO";
import type { AttendanceData, FieldMarks, SubjectMarks } from "./lib/types";
...
function App() {
  ...
  const [subjectMarks, setSubjectMarks] =
    useState<SubjectMarks[]>(defaultSubjects);
          ...
          <div className="space-y-6 print:space-y-3">
            ...
            <div className="grid grid-cols-2 gap-8 mt-12 pt-8 print:mt-6 print:pt-4 print:gap-4 border-t border-[oklch(0.7_0_0)]">
              <div className="text-center">
                <div className="h-16 print:h-12 border-b-2 border-[oklch(0.3_0_0)] mb-2 print:mb-1" />
                <p className="text-sm print:text-xs font-medium text-[oklch(0.3_0_0)]">
                  Class Teacher
                </p>
              </div>
              <div className="text-center">
