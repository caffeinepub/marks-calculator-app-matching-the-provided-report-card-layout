...
export function CoScholasticFields({
  fieldMarks,
  onUpdate,
}: CoScholasticFieldsProps) {
  return (
    <div className="co-scholastic-section">
      <h3 className="text-lg print:text-base font-semibold text-[oklch(0.25_0.05_250)] mb-3 print:mb-2">
        Fields
      </h3>
      <table className="co-scholastic-table w-full border-collapse border-2 border-[oklch(0.3_0_0)] text-sm print:text-xs">
        <thead>
